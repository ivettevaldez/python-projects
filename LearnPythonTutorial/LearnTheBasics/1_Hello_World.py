...
Python 2 and 3 are quite different. This tutorial uses Python 2, 
because it is more widely used and supported. However, 
...
invoked without parentheses. However, in Python 3, it is a function, 
